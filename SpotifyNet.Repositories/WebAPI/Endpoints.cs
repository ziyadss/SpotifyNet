...
internal static class Endpoints
{
    ...
    public static string GetSeveralAlbums(IEnumerable<string> albumIds) =>
        $"https://api.spotify.com/v1/albums?ids={string.Join(',', albumIds)}";
    ...
    public static string CheckUserSavedAlbums(IEnumerable<string> albumIds) =>
        $"https://api.spotify.com/v1/me/albums/contains?ids={string.Join(',', albumIds)}";
    ...
    public static string GetSeveralArtists(IEnumerable<string> artistIds) =>
        $"https://api.spotify.com/v1/artists?ids={string.Join(',', artistIds)}";
    ...
    // Player
    public static string SetPlaybackVolume(int volume) =>
        $"https://api.spotify.com/v1/me/player/volume?volume_percent={volume}";

    public static string SetPlaybackVolume(int volume, string deviceId) =>
    ...
    public static string GetPlaylistItems(string playlistId) =>
    ...
    public static string GetSeveralTracks(IEnumerable<string> trackIds) =>
    ...
    public static string CheckUserSavedTracks(IEnumerable<string> trackIds) =>
        $"https://api.spotify.com/v1/me/tracks/contains?ids={string.Join(',', trackIds)}";

    public static string GetTracksAudioFeatures(IEnumerable<string> trackIds) =>
        $"https://api.spotify.com/v1/audio-features?ids={string.Join(',', trackIds)}";
    ...
    // Users
    public static string GetCurrentUserProfile() => "https://api.spotify.com/v1/me";

    public static string GetCurrentUserTopItems(string type, string timeRange) =>
        $"https://api.spotify.com/v1/me/top/{type}?time_range={timeRange}";

    public static string GetUserProfile(string userId) => $"https://api.spotify.com/v1/users/{userId}";
}
